export function Projects() {
  const projects = [
    {
      ...
      description: 'Enterprise-grade financial management system with real-time transaction processing, multi-currency support, automated reporting, and compliance features. Built with scalable architecture to handle high-volume transactions.',
    ...
    },
    {
      ...
      description: 'Comprehensive Human Resource Management system featuring employee onboarding, payroll processing, attendance tracking, performance reviews, and leave management. Streamlines HR workflows for organizations.',
    ...
    },
    {
      ...
      description: 'Custom enterprise social networking platform for internal team collaboration. Features include real-time messaging, content sharing, activity feeds, and team engagement analytics.',
    ...
    },
    {
      ...
      description: 'Expert in building tailored software solutions from scratch. Specialized in AI-augmented development workflows, rapid prototyping, and delivering production-ready code that solves complex business challenges.',
  ...
  return (
    <section id="projects" className="py-20 bg-gradient-to-b from-white to-slate-50 dark:from-gray-800 dark:to-gray-900">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {projects.map((project, index) => (
            ...
            >
              {/* Gradient Header */}
              <div className={`relative h-48 bg-gradient-to-br ${index === 0 ? 'from-purple-500 to-pink-500' : index === 1 ? 'from-blue-500 to-cyan-500' : index === 2 ? 'from-green-500 to-teal-500' : 'from-orange-500 to-yellow-500'} flex items-center justify-center overflow-hidden`}>
                {/* Decorative elements */}
