...
export const Icon = {
	...
	peerlist: (p: IconProps = {}) => (
		<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" {...p}>
			<path d="M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20Zm0 18.5A8.5 8.5 0 1 1 12 3.5a8.5 8.5 0 0 1 0 17Zm-1.1-13.3h2.2v8.6h-2.2V7.2Zm0-1.8h2.2V4h-2.2v1.4Zm4.4 1.8h2.2v5.4h-2.2V7.2Zm-6.6 0h2.2v8.6H8.7V7.2Zm0 10.4h6.6v1.4H8.7v-1.4Z" />
		</svg>
	),
	mail: (p: IconProps = {}) => (
	...
	star: (p: IconProps = {}) => (
		<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" {...p}>
			<path d="M12 2.5 14.9 8.6l6.6.9-4.8 4.6 1.2 6.5L12 17.6l-5.9 3 1.2-6.5L2.5 9.5l6.6-.9L12 2.5Z" />
		</svg>
	),
	pin: (p: IconProps = {}) => (
		<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" {...p}>
			<path d="M12 21s-6.5-5.3-6.5-10.2a6.5 6.5 0 1 1 13 0C18.5 15.7 12 21 12 21Z" />
			<circle cx="12" cy="10.6" r="2.4" />
		</svg>
	),
	check: (p: IconProps = {}) => (
		<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.6" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" {...p}>
	...
	users: (p: IconProps = {}) => (
		<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" {...p}>
			...
			<path d="M16 5.6a3.5 3.5 0 0 1 0 6.6" />
			<path d="M17.7 14.3a6.5 6.5 0 0 1 3.8 5.7" />
		</svg>
	),
